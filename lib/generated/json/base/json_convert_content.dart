...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case NewsListEntity:
			return newsListEntityFromJson(data as NewsListEntity, json) as T;			case NewsTypeEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case NewsListEntity:
			return newsListEntityToJson(data as NewsListEntity);			case NewsTypeEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'NewsListEntity':
			return NewsListEntity().fromJson(json);			case 'NewsTypeEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'NewsListEntity':
			return List<NewsListEntity>();			case 'NewsTypeEntity':
